@extends('header')
@section('titulo', 'Equipamentos - Novo')
        ...
        <div class="row">
            <div class="col">
                <div class="justify-content-center">
                    <h1 class="text-center mt-4">Cadastrar Equipamento</h1>
                </div>
                <div class="formulario formulario-equipamento my-3">
                    <form action="{{ route('equipamentos.store') }}" method="post" onsubmit="return cadastrarEquipamento();">
                        @csrf
                        <div class="row mx-5">
                            <div class="col">
